...
function Shell({
  ...
  const { state: sidebarState, update: updateSidebarState, loading: sidebarStateLoading } =
    useSidebarState(sessions, !loading);
  const { setPrefs: setLocalPrefs } = useLocalPreferences();
  ...
  const onSidebarDensityChange = useCallback(
    ...
    [setLocalPrefs, updateSidebarState],
  );
  ...
  }, [sidebarState.view.density, sidebarStateLoading, setLocalPrefs]);
            ...
            {view !== "chat" && (
              <div className="absolute inset-0 flex flex-col">
                <SettingsView
                  ...
                  hostChromeInset={showHostChrome}
                  sidebarDensity={sidebarState.view.density}
                  onSidebarDensityChange={onSidebarDensityChange}
                />
              </div>
            )}
          </main>
