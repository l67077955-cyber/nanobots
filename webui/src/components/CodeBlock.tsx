...
import { useLocalPreferenceValue } from "@/hooks/useLocalPreferences";
...
export function CodeBlock({
  ...
  const codeWrapEnabled = useLocalPreferenceValue("codeWrap");
  const resolvedWrapLongLines = wrapLongLines ?? codeWrapEnabled;
    ...
    >
      ...
      {renderAnsi ? (
        ...
        <CodeTextBlock
          ...
          showLineNumbers={showLineNumbers}
          testId="plain-code-fallback"
          className={resolvedWrapLongLines ? "whitespace-pre-wrap" : undefined}
        />
      )}
    </div>
  );
