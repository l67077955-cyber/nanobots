...
interface SettingsViewProps {
  ...
  onSidebarDensityChange?: (density: LocalDensity) => void;
}
...
export function SettingsView({
  ...
  const { prefs: localPrefs, setPrefs: setLocalPrefs } = useLocalPreferences();
      ...
      case "appearance":
        return (
          <AppearanceSettings
            ...
            sidebarDensity={sidebarDensity ?? localPrefs.density}
        ...
        <SettingsGroup>
          ...
          >
            <SegmentedControl
              ...
              onChange={(density) => {
                const nextDensity = density as LocalDensity;
                onChangeLocalPrefs((prev) => ({ ...prev, density: nextDensity }));
                onSidebarDensityChange?.(nextDensity);
              }}
            />
          </SettingsRow>
          <SettingsRow
