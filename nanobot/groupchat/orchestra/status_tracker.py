"""Agent status tracker for broadcast rounds.

Live status dashboard — one message edited in-place showing each agent's
current state (thinking, searching, sending, blocked, etc.).
"""
...
class AgentStatusTracker:
    """Live status dashboard — one message edited in-place.
    ...
    async def finalize(self) -> None:
        ...
        try:
            ...
            logger.debug("Could not edit status message: {}", e)
