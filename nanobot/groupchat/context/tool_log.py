"""Tool-call text blocks appended into History (context layer).

Used by ``commit_agent_turn`` / WorkingMemory so shared transcript sees a
compact tool summary. Not UI formatting (that is display).
"""
